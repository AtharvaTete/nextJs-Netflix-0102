...
export default function ManageAccount() {
  ...
  async function handlePinSubmit(value, index) {
    ...
    if (data.success) {
      ...
      //save the current User Info in the session storage of web
      ...
      <div className="flex justify-center flex-col items-center">
        ...
        <ul className="flex p-0 my-[25px]">
          {accounts && accounts.length
            ...
            : null}
          {/* for minimum account length */}
          {accounts && accounts.length < 4 ? (
            //this onclick is toggel
            <li
        ...
        <div className="text-center ">
          <span
            ...
            className="border border-gary-100 cursor-pointer tracking-wide inline-flex text-sm px-[1.5em] py-[0.5em]"
          >
            Manage Profiles
          </span>
        </div>
